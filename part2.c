...
{
    /* TODO: Implement this function */
    char **ch = malloc(nattempts * sizeof(char*));
    for (int i = 0; i < nattempts; ++i) {
        ch[i] = malloc(wordbufsz * sizeof(char));    
    }
...
{
    /* TODO: Implement this function */
    char *ch = malloc(wordbufsz * sizeof(char));
    return ch; // placeholder
}
...
int main(int argc, char **argv)
{
    ...
    int n;
    if ((n = wordle(answer, nattempts, attempts)) == -1) {
